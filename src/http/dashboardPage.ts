...
<div class="page">
  ...
  <nav class="tabs">
    ...
    <button data-tab="l10">L10</button>
  </nav>
  ...
  <section class="panel" id="panel-l10">
    <div class="card">
      <div class="l10-top">
        <div>
...
(function () {
  ...
  var l10IssueTextDraft = {}; // issueId -> { root, solutions } -- in-flight edits before blur
